...
stat(const char *n, struct stat *st)
{
 ...
 126:	e8 d8 00 00 00       	call   203 <open>
  if(fd < 0)
 ...
 13a:	50                   	push   %eax
 13b:	e8 db 00 00 00       	call   21b <fstat>
...
000001f3 <dump_physmem>:
SYSCALL(dump_physmem)
 1f3:	b8 16 00 00 00       	mov    $0x16,%eax
 1f8:	cd 40                	int    $0x40
 1fa:	c3                   	ret    

000001fb <exec>:
SYSCALL(exec)
 1fb:	b8 07 00 00 00       	mov    $0x7,%eax
 200:	cd 40                	int    $0x40
 202:	c3                   	ret    

00000203 <open>:
SYSCALL(open)
 203:	b8 0f 00 00 00       	mov    $0xf,%eax
 208:	cd 40                	int    $0x40
 20a:	c3                   	ret    

0000020b <mknod>:
SYSCALL(mknod)
 20b:	b8 11 00 00 00       	mov    $0x11,%eax
 210:	cd 40                	int    $0x40
 212:	c3                   	ret    

00000213 <unlink>:
SYSCALL(unlink)
 213:	b8 12 00 00 00       	mov    $0x12,%eax
 218:	cd 40                	int    $0x40
 21a:	c3                   	ret    

0000021b <fstat>:
SYSCALL(fstat)
 21b:	b8 08 00 00 00       	mov    $0x8,%eax
 220:	cd 40                	int    $0x40
 222:	c3                   	ret    

00000223 <link>:
SYSCALL(link)
 223:	b8 13 00 00 00       	mov    $0x13,%eax
 228:	cd 40                	int    $0x40
 22a:	c3                   	ret    

0000022b <mkdir>:
SYSCALL(mkdir)
 22b:	b8 14 00 00 00       	mov    $0x14,%eax
 230:	cd 40                	int    $0x40
 232:	c3                   	ret    

00000233 <chdir>:
SYSCALL(chdir)
 233:	b8 09 00 00 00       	mov    $0x9,%eax
 238:	cd 40                	int    $0x40
 23a:	c3                   	ret    

0000023b <dup>:
SYSCALL(dup)
 23b:	b8 0a 00 00 00       	mov    $0xa,%eax
 240:	cd 40                	int    $0x40
 242:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 4f5:	50                   	push   %eax
 4f6:	e8 50 fd ff ff       	call   24b <sbrk>
  if(p == (char*)-1)
