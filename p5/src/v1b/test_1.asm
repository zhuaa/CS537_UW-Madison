...
main(int argc, char *argv[])
{
  ...
  33:	50                   	push   %eax
  34:	57                   	push   %edi
  35:	e8 15 02 00 00       	call   24f <dump_physmem>
...
stat(const char *n, struct stat *st)
{
 ...
 182:	e8 d8 00 00 00       	call   25f <open>
  if(fd < 0)
 ...
 196:	50                   	push   %eax
 197:	e8 db 00 00 00       	call   277 <fstat>
...
morecore(uint nu)
{
 ...
 551:	50                   	push   %eax
 552:	e8 50 fd ff ff       	call   2a7 <sbrk>
  if(p == (char*)-1)
