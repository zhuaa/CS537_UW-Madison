...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
      ...
      1d:	e8 6e 37 00 00       	call   3790 <mkdir>
  ...
  if(chdir("iputdir") < 0){
      ...
      31:	e8 62 37 00 00       	call   3798 <chdir>
  ...
  if(unlink("../iputdir") < 0){
      ...
      45:	e8 2e 37 00 00       	call   3778 <unlink>
  ...
  if(chdir("/") < 0){
      ...
      59:	e8 3a 37 00 00       	call   3798 <chdir>
...
exitiputtest(void)
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10f:	e8 7c 36 00 00       	call   3790 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     123:	e8 70 36 00 00       	call   3798 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     137:	e8 3c 36 00 00       	call   3778 <unlink>
...
openiputtest(void)
{
  ...
  if(mkdir("oidir") < 0){
     ...
     1e2:	e8 a9 35 00 00       	call   3790 <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     205:	e8 5e 35 00 00       	call   3768 <open>
    if(fd >= 0){
  ...
  sleep(1);
     ...
     261:	6a 01                	push   $0x1
     263:	e8 50 35 00 00       	call   37b8 <sleep>
  if(unlink("oidir") != 0){
     268:	c7 04 24 bb 3b 00 00 	movl   $0x3bbb,(%esp)
     26f:	e8 04 35 00 00       	call   3778 <unlink>
...
opentest(void)
{
  ...
  fd = open("echo", 0);
     ...
     2d0:	e8 93 34 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  fd = open("doesnotexist", 0);
     ...
     2ef:	e8 74 34 00 00       	call   3768 <open>
  if(fd >= 0){
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     368:	e8 fb 33 00 00       	call   3768 <open>
  if(fd >= 0){
  ...
  fd = open("small", O_RDONLY);
     ...
     43a:	e8 29 33 00 00       	call   3768 <open>
  ...
  if(unlink("small") < 0){
     ...
     49a:	e8 d9 32 00 00       	call   3778 <unlink>
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     530:	e8 33 32 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  fd = open("big", O_RDONLY);
     ...
     5b7:	e8 ac 31 00 00       	call   3768 <open>
  ...
  if(unlink("big") < 0){
     ...
     631:	e8 42 31 00 00       	call   3778 <unlink>
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     6ff:	e8 64 30 00 00       	call   3768 <open>
    close(fd);
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     73c:	e8 37 30 00 00       	call   3778 <unlink>
  for(i = 0; i < 52; i++){
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     784:	e8 07 30 00 00       	call   3790 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     798:	e8 fb 2f 00 00       	call   3798 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     7ac:	e8 e7 2f 00 00       	call   3798 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     7c0:	e8 b3 2f 00 00       	call   3778 <unlink>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     867:	e8 f4 2e 00 00       	call   3760 <exec>
...
mem(void)
{
  ...
  ppid = getpid();
     bed:	e8 b6 2b 00 00       	call   37a8 <getpid>
...
sharedfd(void)
{
  ...
  fd = open("sharedfd", 0);
     ...
     d66:	e8 fd 29 00 00       	call   3768 <open>
  ...
  unlink("sharedfd");
     ...
     de5:	e8 8e 29 00 00       	call   3778 <unlink>
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    unlink(fname);
     ...
     e79:	57                   	push   %edi
     e7a:	e8 f9 28 00 00       	call   3778 <unlink>
  ...
  for(pi = 0; pi < 4; pi++){
     ...
     eb2:	57                   	push   %edi
     eb3:	e8 b0 28 00 00       	call   3768 <open>
  ...
  for(i = 0; i < 2; i++){
    ...
    unlink(fname);
     ...
     fb4:	e8 bf 27 00 00       	call   3778 <unlink>
  for(i = 0; i < 2; i++){
    ...
    fd = open(fname, 0);
     ...
     fce:	6a 00                	push   $0x0
     fd0:	50                   	push   %eax
     fd1:	e8 92 27 00 00       	call   3768 <open>
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    109b:	50                   	push   %eax
    109c:	e8 c7 26 00 00       	call   3768 <open>
        if(fd < 0){
    ...
    10d2:	50                   	push   %eax
    10d3:	e8 a0 26 00 00       	call   3778 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    114a:	50                   	push   %eax
    114b:	e8 18 26 00 00       	call   3768 <open>
      if((i == 0 || i >= N/2) && fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    11d3:	50                   	push   %eax
    11d4:	e8 9f 25 00 00       	call   3778 <unlink>
    for(pi = 0; pi < 4; pi++){
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    122d:	e8 36 25 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1261:	e8 02 25 00 00       	call   3768 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    127b:	e8 f8 24 00 00       	call   3778 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1298:	e8 cb 24 00 00       	call   3768 <open>
  ...
  unlink("unlinkread");
    ...
    130f:	e8 64 24 00 00       	call   3778 <unlink>
...
linktest(void)
{
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1421:	e8 62 23 00 00       	call   3788 <link>
  ...
  unlink("lf1");
    ...
    1439:	e8 3a 23 00 00       	call   3778 <unlink>

  if(open("lf1", 0) >= 0){
    143e:	83 c4 08             	add    $0x8,%esp
    1441:	6a 00                	push   $0x0
    1443:	68 ca 40 00 00       	push   $0x40ca
    1448:	e8 1b 23 00 00       	call   3768 <open>
  ...
  fd = open("lf2", 0);
    ...
    1462:	e8 01 23 00 00       	call   3768 <open>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14a9:	e8 da 22 00 00       	call   3788 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    14f0:	e8 93 22 00 00       	call   3788 <link>
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1623:	50                   	push   %eax
    1624:	e8 3f 21 00 00       	call   3768 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    1665:	50                   	push   %eax
    1666:	e8 0d 21 00 00       	call   3778 <unlink>
    pid = fork();
    ...
    16a9:	e8 da 20 00 00       	call   3788 <link>
    ...
    16bf:	e8 c4 20 00 00       	call   3788 <link>
  ...
  fd = open(".", 0);
    ...
    1703:	e8 60 20 00 00       	call   3768 <open>
  ...
  for(i = 0; i < 40; i++){
    ...
    17d3:	57                   	push   %edi
    17d4:	e8 8f 1f 00 00       	call   3768 <open>
    ...
    17e4:	6a 00                	push   $0x0
    17e6:	57                   	push   %edi
    17e7:	e8 7c 1f 00 00       	call   3768 <open>
    ...
    17f7:	6a 00                	push   $0x0
    17f9:	57                   	push   %edi
    17fa:	e8 69 1f 00 00       	call   3768 <open>
    ...
    180a:	6a 00                	push   $0x0
    180c:	57                   	push   %edi
    180d:	e8 56 1f 00 00       	call   3768 <open>
  ...
  for(i = 0; i < 40; i++){
    ...
    1877:	57                   	push   %edi
    1878:	e8 fb 1e 00 00       	call   3778 <unlink>
      unlink(file);
    187d:	89 3c 24             	mov    %edi,(%esp)
    1880:	e8 f3 1e 00 00       	call   3778 <unlink>
      unlink(file);
    1885:	89 3c 24             	mov    %edi,(%esp)
    1888:	e8 eb 1e 00 00       	call   3778 <unlink>
      unlink(file);
    188d:	89 3c 24             	mov    %edi,(%esp)
    1890:	e8 e3 1e 00 00       	call   3778 <unlink>
...
linkunlink()
{
  ...
  unlink("x");
    ...
    18d5:	e8 9e 1e 00 00       	call   3778 <unlink>
  pid = fork();
  ...
  for(i = 0; i < 100; i++){
    ...
    1920:	e8 43 1e 00 00       	call   3768 <open>
  ...
  for(i = 0; i < 100; i++){
    ...
    1965:	e8 0e 1e 00 00       	call   3778 <unlink>
    ...
    197c:	e8 07 1e 00 00       	call   3788 <link>
...
bigdir(void)
{
  ...
  for(i = 0; i < 500; i++){
    ...
    1a37:	e8 4c 1d 00 00       	call   3788 <link>
  ...
  unlink("bd");
    ...
    1a78:	e8 fb 1c 00 00       	call   3778 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1ac2:	50                   	push   %eax
    1ac3:	e8 b0 1c 00 00       	call   3778 <unlink>
...
subdir(void)
{
  ...
  unlink("ff");
    ...
    1b19:	e8 5a 1c 00 00       	call   3778 <unlink>
  if(mkdir("dd") != 0){
    1b1e:	c7 04 24 8c 43 00 00 	movl   $0x438c,(%esp)
    1b25:	e8 66 1c 00 00       	call   3790 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b42:	e8 21 1c 00 00       	call   3768 <open>
  ...
  if(unlink("dd") >= 0){
    ...
    1b73:	e8 00 1c 00 00       	call   3778 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b8b:	e8 00 1c 00 00       	call   3790 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba8:	e8 bb 1b 00 00       	call   3768 <open>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1bdc:	e8 87 1b 00 00       	call   3768 <open>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1c30:	e8 53 1b 00 00       	call   3788 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c48:	e8 2b 1b 00 00       	call   3778 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c62:	e8 01 1b 00 00       	call   3768 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1c7a:	e8 19 1b 00 00       	call   3798 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c92:	e8 01 1b 00 00       	call   3798 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1caa:	e8 e9 1a 00 00       	call   3798 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1cc2:	e8 d1 1a 00 00       	call   3798 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cdc:	e8 87 1a 00 00       	call   3768 <open>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d20:	e8 43 1a 00 00       	call   3768 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d3d:	e8 26 1a 00 00       	call   3768 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d5a:	e8 09 1a 00 00       	call   3768 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d77:	e8 ec 19 00 00       	call   3768 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d91:	e8 d2 19 00 00       	call   3768 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1dab:	e8 b8 19 00 00       	call   3768 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dc8:	e8 bb 19 00 00       	call   3788 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1de5:	e8 9e 19 00 00       	call   3788 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1e02:	e8 81 19 00 00       	call   3788 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e1a:	e8 71 19 00 00       	call   3790 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e32:	e8 59 19 00 00       	call   3790 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e4a:	e8 41 19 00 00       	call   3790 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e62:	e8 11 19 00 00       	call   3778 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e7a:	e8 f9 18 00 00       	call   3778 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e92:	e8 01 19 00 00       	call   3798 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    1eaa:	e8 e9 18 00 00       	call   3798 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ec2:	e8 b1 18 00 00       	call   3778 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    1eda:	e8 99 18 00 00       	call   3778 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    1ef2:	e8 81 18 00 00       	call   3778 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f0a:	e8 69 18 00 00       	call   3778 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    1f22:	e8 51 18 00 00       	call   3778 <unlink>
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    2249:	e8 2a 15 00 00       	call   3778 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    228f:	e8 e4 14 00 00       	call   3778 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22b2:	e8 b1 14 00 00       	call   3768 <open>
...
bigfile(void)
{
  ...
  fd = open("bigfile", 0);
    ...
    23b5:	e8 ae 13 00 00       	call   3768 <open>
  ...
  unlink("bigfile");
    ...
    2484:	e8 ef 12 00 00       	call   3778 <unlink>
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    24d0:	e8 bb 12 00 00       	call   3790 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e8:	e8 a3 12 00 00       	call   3790 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2505:	e8 5e 12 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2528:	e8 3b 12 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2548:	e8 43 12 00 00       	call   3790 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    255c:	e8 2f 12 00 00       	call   3790 <mkdir>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    260d:	e8 7e 11 00 00       	call   3790 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2625:	e8 6e 11 00 00       	call   3798 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    263d:	e8 36 11 00 00       	call   3778 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2655:	e8 1e 11 00 00       	call   3778 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    266d:	e8 26 11 00 00       	call   3798 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2685:	e8 ee 10 00 00       	call   3778 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    269d:	e8 d6 10 00 00       	call   3778 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    26b5:	e8 be 10 00 00       	call   3778 <unlink>
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2799:	e8 ca 0f 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  if(chdir("dirfile") == 0){
    ...
    27b9:	e8 da 0f 00 00       	call   3798 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    27d3:	e8 90 0f 00 00       	call   3768 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27f0:	e8 73 0f 00 00       	call   3768 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2808:	e8 83 0f 00 00       	call   3790 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2820:	e8 53 0f 00 00       	call   3778 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    283d:	e8 46 0f 00 00       	call   3788 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2855:	e8 1e 0f 00 00       	call   3778 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    286f:	e8 f4 0e 00 00       	call   3768 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2889:	e8 da 0e 00 00       	call   3768 <open>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29f1:	e8 82 0d 00 00       	call   3778 <unlink>
  for(i = 0; i < 50 + 1; i++){
    ...
    2a0d:	e8 7e 0d 00 00       	call   3790 <mkdir>
    ...
    2a21:	e8 72 0d 00 00       	call   3798 <chdir>
    ...
    2a76:	e8 ed 0c 00 00       	call   3768 <open>
    if(fd >= 0)
  ...
  chdir("/");
    ...
    2a9f:	e8 f4 0c 00 00       	call   3798 <chdir>
...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    2b8c:	e8 1f 0c 00 00       	call   37b0 <sbrk>
    2b91:	89 c7                	mov    %eax,%edi

  // can one sbrk() less than a page?
  a = sbrk(0);
    2b93:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2b9a:	e8 11 0c 00 00       	call   37b0 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bb4:	6a 01                	push   $0x1
    2bb6:	e8 f5 0b 00 00       	call   37b0 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    ...
    2bfd:	6a 01                	push   $0x1
    2bff:	e8 ac 0b 00 00       	call   37b0 <sbrk>
  c = sbrk(1);
    2c04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c0b:	e8 a0 0b 00 00       	call   37b0 <sbrk>
  if(c != a + 1){
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    2c2e:	6a 00                	push   $0x0
    2c30:	e8 7b 0b 00 00       	call   37b0 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2c41:	e8 6a 0b 00 00       	call   37b0 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2c5b:	6a 00                	push   $0x0
    2c5d:	e8 4e 0b 00 00       	call   37b0 <sbrk>
    2c62:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2c64:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
    2c6b:	e8 40 0b 00 00       	call   37b0 <sbrk>
  ...
  c = sbrk(0);
    ...
    2c7f:	6a 00                	push   $0x0
    2c81:	e8 2a 0b 00 00       	call   37b0 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2c9a:	6a 00                	push   $0x0
    2c9c:	e8 0f 0b 00 00       	call   37b0 <sbrk>
    2ca1:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2ca3:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2caa:	e8 01 0b 00 00       	call   37b0 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2cbf:	6a 00                	push   $0x0
    2cc1:	e8 ea 0a 00 00       	call   37b0 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2d24:	e8 7f 0a 00 00       	call   37a8 <getpid>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2eac:	e8 07 09 00 00       	call   37b8 <sleep>
  ...
  c = sbrk(4096);
    ...
    2eee:	e8 bd 08 00 00       	call   37b0 <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f26:	6a 00                	push   $0x0
    2f28:	e8 83 08 00 00       	call   37b0 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f6d:	6a 00                	push   $0x0
    2f6f:	e8 3c 08 00 00       	call   37b0 <sbrk>
    2f74:	29 c7                	sub    %eax,%edi
    2f76:	89 3c 24             	mov    %edi,(%esp)
    2f79:	e8 32 08 00 00       	call   37b0 <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fbe:	6a 00                	push   $0x0
    2fc0:	e8 f3 07 00 00       	call   37b8 <sleep>
    sleep(0);
    2fc5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2fcc:	e8 e7 07 00 00       	call   37b8 <sleep>
    kill(pid);
    ...
    2fe7:	e8 9c 07 00 00       	call   3788 <link>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    30a4:	e8 cf 06 00 00       	call   3778 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    30cc:	e8 97 06 00 00       	call   3768 <open>
  if(fd < 0){
  ...
  unlink("bigarg-ok");
    ...
    30ec:	e8 87 06 00 00       	call   3778 <unlink>
}
    ...
    3133:	e8 28 06 00 00       	call   3760 <exec>
    printf(stdout, "bigarg test ok\n");
    ...
    3158:	e8 0b 06 00 00       	call   3768 <open>
    close(fd);
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3256:	56                   	push   %esi
    3257:	e8 0c 05 00 00       	call   3768 <open>
  ...
  while(nfiles >= 0){
    ...
    335b:	50                   	push   %eax
    335c:	e8 17 04 00 00       	call   3778 <unlink>
    nfiles--;
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    340b:	e8 58 03 00 00       	call   3768 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    341c:	6a 00                	push   $0x0
    341e:	e8 8d 03 00 00       	call   37b0 <sbrk>
...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    34a5:	e8 be 02 00 00       	call   3768 <open>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34d2:	e8 91 02 00 00       	call   3768 <open>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    368b:	e8 d8 00 00 00       	call   3768 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    369f:	50                   	push   %eax
    36a0:	e8 db 00 00 00       	call   3780 <fstat>
...
00003758 <dump_physmem>:
SYSCALL(dump_physmem)
    3758:	b8 16 00 00 00       	mov    $0x16,%eax
    375d:	cd 40                	int    $0x40
    375f:	c3                   	ret    

00003760 <exec>:
SYSCALL(exec)
    3760:	b8 07 00 00 00       	mov    $0x7,%eax
    3765:	cd 40                	int    $0x40
    3767:	c3                   	ret    

00003768 <open>:
SYSCALL(open)
    3768:	b8 0f 00 00 00       	mov    $0xf,%eax
    376d:	cd 40                	int    $0x40
    376f:	c3                   	ret    

00003770 <mknod>:
SYSCALL(mknod)
    3770:	b8 11 00 00 00       	mov    $0x11,%eax
    3775:	cd 40                	int    $0x40
    3777:	c3                   	ret    

00003778 <unlink>:
SYSCALL(unlink)
    3778:	b8 12 00 00 00       	mov    $0x12,%eax
    377d:	cd 40                	int    $0x40
    377f:	c3                   	ret    

00003780 <fstat>:
SYSCALL(fstat)
    3780:	b8 08 00 00 00       	mov    $0x8,%eax
    3785:	cd 40                	int    $0x40
    3787:	c3                   	ret    

00003788 <link>:
SYSCALL(link)
    3788:	b8 13 00 00 00       	mov    $0x13,%eax
    378d:	cd 40                	int    $0x40
    378f:	c3                   	ret    

00003790 <mkdir>:
SYSCALL(mkdir)
    3790:	b8 14 00 00 00       	mov    $0x14,%eax
    3795:	cd 40                	int    $0x40
    3797:	c3                   	ret    

00003798 <chdir>:
SYSCALL(chdir)
    3798:	b8 09 00 00 00       	mov    $0x9,%eax
    379d:	cd 40                	int    $0x40
    379f:	c3                   	ret    

000037a0 <dup>:
SYSCALL(dup)
    37a0:	b8 0a 00 00 00       	mov    $0xa,%eax
    37a5:	cd 40                	int    $0x40
    37a7:	c3                   	ret    

000037a8 <getpid>:
SYSCALL(getpid)
    37a8:	b8 0b 00 00 00       	mov    $0xb,%eax
    37ad:	cd 40                	int    $0x40
    37af:	c3                   	ret    

000037b0 <sbrk>:
SYSCALL(sbrk)
    37b0:	b8 0c 00 00 00       	mov    $0xc,%eax
    37b5:	cd 40                	int    $0x40
    37b7:	c3                   	ret    

000037b8 <sleep>:
SYSCALL(sleep)
    37b8:	b8 0d 00 00 00       	mov    $0xd,%eax
    37bd:	cd 40                	int    $0x40
    37bf:	c3                   	ret    

000037c0 <uptime>:
SYSCALL(uptime)
    37c0:	b8 0e 00 00 00       	mov    $0xe,%eax
    37c5:	cd 40                	int    $0x40
    37c7:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3a5a:	50                   	push   %eax
    3a5b:	e8 50 fd ff ff       	call   37b0 <sbrk>
  if(p == (char*)-1)
