...
main(void)
{
  ...
  19:	e8 96 02 00 00       	call   2b4 <open>
  ...
  28:	6a 00                	push   $0x0
  2a:	e8 bd 02 00 00       	call   2ec <dup>
  dup(0);  // stderr
  2f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  36:	e8 b1 02 00 00       	call   2ec <dup>
  ...
  4c:	e8 6b 02 00 00       	call   2bc <mknod>
    open("console", O_RDWR);
  51:	83 c4 08             	add    $0x8,%esp
  54:	6a 02                	push   $0x2
  56:	68 68 06 00 00       	push   $0x668
  5b:	e8 54 02 00 00       	call   2b4 <open>
  ...
  c6:	e8 e1 01 00 00       	call   2ac <exec>
      printf(1, "init: exec sh failed\n");
...
stat(const char *n, struct stat *st)
{
 ...
 1d7:	e8 d8 00 00 00       	call   2b4 <open>
  if(fd < 0)
 ...
 1eb:	50                   	push   %eax
 1ec:	e8 db 00 00 00       	call   2cc <fstat>
...
morecore(uint nu)
{
 ...
 5a6:	50                   	push   %eax
 5a7:	e8 50 fd ff ff       	call   2fc <sbrk>
  if(p == (char*)-1)
