...
main(int argc, char *argv[])
{
 ...
 108:	6a 00                	push   $0x0
 10a:	ff 37                	pushl  (%edi)
 10c:	e8 28 02 00 00       	call   339 <open>
...
stat(const char *n, struct stat *st)
{
 ...
 25c:	e8 d8 00 00 00       	call   339 <open>
  if(fd < 0)
 ...
 270:	50                   	push   %eax
 271:	e8 db 00 00 00       	call   351 <fstat>
...
morecore(uint nu)
{
 ...
 62b:	50                   	push   %eax
 62c:	e8 50 fd ff ff       	call   381 <sbrk>
  if(p == (char*)-1)
