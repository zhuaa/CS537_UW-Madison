...
000001d8 <main>:
{
 ...
 21e:	6a 00                	push   $0x0
 220:	ff 37                	pushl  (%edi)
 222:	e8 39 02 00 00       	call   460 <open>
...
stat(const char *n, struct stat *st)
{
 ...
 383:	e8 d8 00 00 00       	call   460 <open>
  if(fd < 0)
 ...
 397:	50                   	push   %eax
 398:	e8 db 00 00 00       	call   478 <fstat>
...
morecore(uint nu)
{
 ...
 752:	50                   	push   %eax
 753:	e8 50 fd ff ff       	call   4a8 <sbrk>
  if(p == (char*)-1)
