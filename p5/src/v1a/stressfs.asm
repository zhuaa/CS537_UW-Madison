...
main(int argc, char *argv[])
{
  ...
  85:	50                   	push   %eax
  86:	e8 66 02 00 00       	call   2f1 <open>
...
//    printf(fd, "%d\n", i);
  ...
  d7:	50                   	push   %eax
  d8:	e8 14 02 00 00       	call   2f1 <open>
...
stat(const char *n, struct stat *st)
{
 ...
 214:	e8 d8 00 00 00       	call   2f1 <open>
  if(fd < 0)
 ...
 228:	50                   	push   %eax
 229:	e8 db 00 00 00       	call   309 <fstat>
...
000002e1 <dump_physmem>:
SYSCALL(dump_physmem)
 2e1:	b8 16 00 00 00       	mov    $0x16,%eax
 2e6:	cd 40                	int    $0x40
 2e8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 5e3:	50                   	push   %eax
 5e4:	e8 50 fd ff ff       	call   339 <sbrk>
  if(p == (char*)-1)
