...
00000084 <runcmd>:
{
  ...
  bf:	52                   	push   %edx
  c0:	50                   	push   %eax
  c1:	e8 c8 0a 00 00       	call   b8e <exec>
  ...
  f9:	e8 98 0a 00 00       	call   b96 <open>
 ...
 1b5:	e8 14 0a 00 00       	call   bce <dup>
      close(p[0]);
 ...
 1eb:	e8 de 09 00 00       	call   bce <dup>
      close(p[0]);
...
000008ee <main>:
{
 ...
 909:	e8 88 02 00 00       	call   b96 <open>
 ...
 982:	e8 3f 02 00 00       	call   bc6 <chdir>
...
stat(const char *n, struct stat *st)
{
 ...
 ab9:	e8 d8 00 00 00       	call   b96 <open>
  if(fd < 0)
 ...
 acd:	50                   	push   %eax
 ace:	e8 db 00 00 00       	call   bae <fstat>
...
00000b86 <dump_physmem>:
SYSCALL(dump_physmem)
 b86:	b8 16 00 00 00       	mov    $0x16,%eax
 b8b:	cd 40                	int    $0x40
 b8d:	c3                   	ret    

00000b8e <exec>:
SYSCALL(exec)
 b8e:	b8 07 00 00 00       	mov    $0x7,%eax
 b93:	cd 40                	int    $0x40
 b95:	c3                   	ret    

00000b96 <open>:
SYSCALL(open)
 b96:	b8 0f 00 00 00       	mov    $0xf,%eax
 b9b:	cd 40                	int    $0x40
 b9d:	c3                   	ret    

00000b9e <mknod>:
SYSCALL(mknod)
 b9e:	b8 11 00 00 00       	mov    $0x11,%eax
 ba3:	cd 40                	int    $0x40
 ba5:	c3                   	ret    

00000ba6 <unlink>:
SYSCALL(unlink)
 ba6:	b8 12 00 00 00       	mov    $0x12,%eax
 bab:	cd 40                	int    $0x40
 bad:	c3                   	ret    

00000bae <fstat>:
SYSCALL(fstat)
 bae:	b8 08 00 00 00       	mov    $0x8,%eax
 bb3:	cd 40                	int    $0x40
 bb5:	c3                   	ret    

00000bb6 <link>:
SYSCALL(link)
 bb6:	b8 13 00 00 00       	mov    $0x13,%eax
 bbb:	cd 40                	int    $0x40
 bbd:	c3                   	ret    

00000bbe <mkdir>:
SYSCALL(mkdir)
 bbe:	b8 14 00 00 00       	mov    $0x14,%eax
 bc3:	cd 40                	int    $0x40
 bc5:	c3                   	ret    

00000bc6 <chdir>:
SYSCALL(chdir)
 bc6:	b8 09 00 00 00       	mov    $0x9,%eax
 bcb:	cd 40                	int    $0x40
 bcd:	c3                   	ret    

00000bce <dup>:
SYSCALL(dup)
 bce:	b8 0a 00 00 00       	mov    $0xa,%eax
 bd3:	cd 40                	int    $0x40
 bd5:	c3                   	ret    

00000bd6 <getpid>:
SYSCALL(getpid)
 bd6:	b8 0b 00 00 00       	mov    $0xb,%eax
 bdb:	cd 40                	int    $0x40
 bdd:	c3                   	ret    

00000bde <sbrk>:
SYSCALL(sbrk)
 bde:	b8 0c 00 00 00       	mov    $0xc,%eax
 be3:	cd 40                	int    $0x40
 be5:	c3                   	ret    

00000be6 <sleep>:
SYSCALL(sleep)
 be6:	b8 0d 00 00 00       	mov    $0xd,%eax
 beb:	cd 40                	int    $0x40
 bed:	c3                   	ret    

00000bee <uptime>:
SYSCALL(uptime)
 bee:	b8 0e 00 00 00       	mov    $0xe,%eax
 bf3:	cd 40                	int    $0x40
 bf5:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 e88:	50                   	push   %eax
 e89:	e8 50 fd ff ff       	call   bde <sbrk>
  if(p == (char*)-1)
