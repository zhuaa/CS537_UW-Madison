...
main(int argc, char *argv[])
{
  ...
  31:	ff 36                	pushl  (%esi)
  33:	e8 1e 02 00 00       	call   256 <unlink>
...
stat(const char *n, struct stat *st)
{
 ...
 169:	e8 d8 00 00 00       	call   246 <open>
  if(fd < 0)
 ...
 17d:	50                   	push   %eax
 17e:	e8 db 00 00 00       	call   25e <fstat>
...
00000236 <dump_physmem>:
SYSCALL(dump_physmem)
 236:	b8 16 00 00 00       	mov    $0x16,%eax
 23b:	cd 40                	int    $0x40
 23d:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 538:	50                   	push   %eax
 539:	e8 50 fd ff ff       	call   28e <sbrk>
  if(p == (char*)-1)
