...
stat(const char *n, struct stat *st)
{
 ...
 149:	e8 d8 00 00 00       	call   226 <open>
  if(fd < 0)
 ...
 15d:	50                   	push   %eax
 15e:	e8 db 00 00 00       	call   23e <fstat>
...
0000021e <exec>:
SYSCALL(exec)
 21e:	b8 07 00 00 00       	mov    $0x7,%eax
 223:	cd 40                	int    $0x40
 225:	c3                   	ret    

00000226 <open>:
SYSCALL(open)
 226:	b8 0f 00 00 00       	mov    $0xf,%eax
 22b:	cd 40                	int    $0x40
 22d:	c3                   	ret    

0000022e <mknod>:
SYSCALL(mknod)
 22e:	b8 11 00 00 00       	mov    $0x11,%eax
 233:	cd 40                	int    $0x40
 235:	c3                   	ret    

00000236 <unlink>:
SYSCALL(unlink)
 236:	b8 12 00 00 00       	mov    $0x12,%eax
 23b:	cd 40                	int    $0x40
 23d:	c3                   	ret    

0000023e <fstat>:
SYSCALL(fstat)
 23e:	b8 08 00 00 00       	mov    $0x8,%eax
 243:	cd 40                	int    $0x40
 245:	c3                   	ret    

00000246 <link>:
SYSCALL(link)
 246:	b8 13 00 00 00       	mov    $0x13,%eax
 24b:	cd 40                	int    $0x40
 24d:	c3                   	ret    

0000024e <mkdir>:
SYSCALL(mkdir)
 24e:	b8 14 00 00 00       	mov    $0x14,%eax
 253:	cd 40                	int    $0x40
 255:	c3                   	ret    

00000256 <chdir>:
SYSCALL(chdir)
 256:	b8 09 00 00 00       	mov    $0x9,%eax
 25b:	cd 40                	int    $0x40
 25d:	c3                   	ret    

0000025e <dup>:
SYSCALL(dup)
 25e:	b8 0a 00 00 00       	mov    $0xa,%eax
 263:	cd 40                	int    $0x40
 265:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 518:	50                   	push   %eax
 519:	e8 50 fd ff ff       	call   26e <sbrk>
  if(p == (char*)-1)
