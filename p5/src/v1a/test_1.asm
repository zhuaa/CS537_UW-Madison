...
main(int argc, char *argv[])
{
  ...
  33:	50                   	push   %eax
  34:	56                   	push   %esi
  35:	e8 10 02 00 00       	call   24a <dump_physmem>
...
stat(const char *n, struct stat *st)
{
 ...
 17d:	e8 d8 00 00 00       	call   25a <open>
  if(fd < 0)
 ...
 191:	50                   	push   %eax
 192:	e8 db 00 00 00       	call   272 <fstat>
...
00000252 <exec>:
SYSCALL(exec)
 252:	b8 07 00 00 00       	mov    $0x7,%eax
 257:	cd 40                	int    $0x40
 259:	c3                   	ret    

0000025a <open>:
SYSCALL(open)
 25a:	b8 0f 00 00 00       	mov    $0xf,%eax
 25f:	cd 40                	int    $0x40
 261:	c3                   	ret    

00000262 <mknod>:
SYSCALL(mknod)
 262:	b8 11 00 00 00       	mov    $0x11,%eax
 267:	cd 40                	int    $0x40
 269:	c3                   	ret    

0000026a <unlink>:
SYSCALL(unlink)
 26a:	b8 12 00 00 00       	mov    $0x12,%eax
 26f:	cd 40                	int    $0x40
 271:	c3                   	ret    

00000272 <fstat>:
SYSCALL(fstat)
 272:	b8 08 00 00 00       	mov    $0x8,%eax
 277:	cd 40                	int    $0x40
 279:	c3                   	ret    

0000027a <link>:
SYSCALL(link)
 27a:	b8 13 00 00 00       	mov    $0x13,%eax
 27f:	cd 40                	int    $0x40
 281:	c3                   	ret    

00000282 <mkdir>:
SYSCALL(mkdir)
 282:	b8 14 00 00 00       	mov    $0x14,%eax
 287:	cd 40                	int    $0x40
 289:	c3                   	ret    

0000028a <chdir>:
SYSCALL(chdir)
 28a:	b8 09 00 00 00       	mov    $0x9,%eax
 28f:	cd 40                	int    $0x40
 291:	c3                   	ret    

00000292 <dup>:
SYSCALL(dup)
 292:	b8 0a 00 00 00       	mov    $0xa,%eax
 297:	cd 40                	int    $0x40
 299:	c3                   	ret    

0000029a <getpid>:
SYSCALL(getpid)
 29a:	b8 0b 00 00 00       	mov    $0xb,%eax
 29f:	cd 40                	int    $0x40
 2a1:	c3                   	ret    

000002a2 <sbrk>:
SYSCALL(sbrk)
 2a2:	b8 0c 00 00 00       	mov    $0xc,%eax
 2a7:	cd 40                	int    $0x40
 2a9:	c3                   	ret    

000002aa <sleep>:
SYSCALL(sleep)
 2aa:	b8 0d 00 00 00       	mov    $0xd,%eax
 2af:	cd 40                	int    $0x40
 2b1:	c3                   	ret    

000002b2 <uptime>:
SYSCALL(uptime)
 2b2:	b8 0e 00 00 00       	mov    $0xe,%eax
 2b7:	cd 40                	int    $0x40
 2b9:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 54c:	50                   	push   %eax
 54d:	e8 50 fd ff ff       	call   2a2 <sbrk>
  if(p == (char*)-1)
