...
ls(char *path)
{
  ...
  9c:	6a 00                	push   $0x0
  9e:	56                   	push   %esi
  9f:	e8 16 04 00 00       	call   4ba <open>
  ...
  ba:	50                   	push   %eax
  bb:	53                   	push   %ebx
  bc:	e8 11 04 00 00       	call   4d2 <fstat>
...
stat(const char *n, struct stat *st)
{
 ...
 3dd:	e8 d8 00 00 00       	call   4ba <open>
  if(fd < 0)
 ...
 3f1:	50                   	push   %eax
 3f2:	e8 db 00 00 00       	call   4d2 <fstat>
...
morecore(uint nu)
{
 ...
 7ac:	50                   	push   %eax
 7ad:	e8 50 fd ff ff       	call   502 <sbrk>
  if(p == (char*)-1)
